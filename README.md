...
<p align="center">
  ...
  <a href="mailto:harishkarthikaya@gmail.com"><img src="https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white"/></a>
...
- ⚡ Hands-on with embedded systems, IoT, and antenna design/fabrication
- 💬 Ask me about React, IoT, or full-stack web apps
...
|---|---|---|
| **[Traveloop](https://github.com/Harish-Karthikaya)** – Intelligent Travel Planning Web App | All-in-one travel planning platform to build custom itineraries, track trip budgets with charts, and manage packing checklists. | React.js, Tailwind CSS, Supabase |
| **[GreenSphere](https://github.com/Harish-Karthikaya)** – Interactive Sustainability Intelligence Platform | A web-based sustainability platform integrating a City Digital Twin, Product Impact Explorer, and Climate Simulator. | React.js, JavaScript, HTML, CSS, Chart.js, Node.js/Python |
| **AI-Driven Platform for Oceanographic, Fisheries & Biodiversity Management** *(Smart India Hackathon)* | AI-based platform for analyzing oceanographic data, fisheries monitoring, and biodiversity management. | Python, AI/ML Concepts, Data Analytics, Cloud Integration |
| **Cloud-Integrated Facility Automation System** | Cloud-connected system for remote monitoring and automation of facility operations. | AWS (EC2, S3, IAM), IoT, Arduino, Python |
| **AI Desktop Assistant** *(Hobby)* | Voice-controlled desktop assistant for task automation and basic system operations. | Python, Speech Recognition, Text-to-Speech, Automation Libraries |

---

### 🏆 Achievements & Certifications

- 🎤 Presented a paper at **ICAWCNS'26**
- 🥈 **2nd Place** – Robo Tracer, ELECTRA, Coimbatore Institute of Technology (CIT)
- 🥈 **2nd Place** – Project Presentation, PRAKRITI'26, Government College of Technology (GCT)
- 📄 Paper & Project Presentations – Anna University, GCT, Karpagam College
- ✅ HackerRank – Python (Basic), Java (Basic), Problem Solving (Basic)
- ✅ NPTEL – Industry 4.0, Geographic Information System (GIS)
- ✅ AWS Skill Builder | Linux Unhatched (Cisco) | Prompt Engineering (Simplilearn) | Spring Boot (Guvi)
